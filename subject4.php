...
a:hover, a:active {
  ...
  <a href="admindash.php">back to dashboard</a>
    ...
    <div class="container">
      <div class="row">
        <form action="subject4.php" method="post" enctype="multipart/form-data" >
          <h3>Upload File</h3>
    ...
    <div style="background-color:blue;margin-right:300px;">
          ...
          //session_start();
          $self_ID = $_SESSION['id'];
          $files  = mysqli_query($con, "SELECT name from files4 where userID = $self_ID");
